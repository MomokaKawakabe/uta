<template>
  <div class="page-article">
    <div v-if="!isError" class="article-content">
      ...
      <div class="article-abstract content-text">
        {{ article.abstract }}
      </div>
      <div class="article-body content-text">
        {{ article.body }}
      </div>
      <div class="article-tags content-text">
        vue | 技术
      </div>
    </div>
...
export default Vue.extend({
  ...
  data () {
    return {
      ...
      article: {
        title: '写给聪明人',
        abstract: '从武汉，到北京，再到广州，然后是英国，一路上说难不难，说容易也不容易。我的原生家庭不太能给我提供太多帮助，于是每到一个新地方，一切都得靠自己打拼，很多东西需要自己摸索。现在慢慢静下来，就想写一篇经验性的文章，给后辈里的聪明人看。因为我想，如果你是聪明人，一定能懂得这篇文章里的含义。',
        body: '拥有选择权，是人和人最大的区别\n' +
